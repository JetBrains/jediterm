...
import ai.rever.bossterm.core.input.KeyEvent
import ai.rever.bossterm.core.typeahead.TerminalTypeAheadManager
import ai.rever.bossterm.core.typeahead.TerminalTypeAheadManager.TypeAheadEvent.Companion.fromByteArray
import ai.rever.bossterm.core.typeahead.TerminalTypeAheadManager.TypeAheadEvent.Companion.fromString
import ai.rever.bossterm.core.util.TermSize
import ai.rever.bossterm.terminal.emulator.Emulator
...
class TerminalStarter(
    private val myTerminal: BossTerminal,
    ...
    protected fun createEmulator(dataStream: TerminalDataStream?, terminal: Terminal?): BossEmulator {
        return BossEmulator(dataStream ?: throw IllegalArgumentException("dataStream cannot be null"), terminal)
    }
    ...
    @Deprecated("use {@link BossTerminal#getCodeForKey(int, int)} instead")
