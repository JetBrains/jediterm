...
import static com.jediterm.core.awtCompat.KeyEvent.*;

/**
 * @author traff
 */
public class TerminalKeyEncoder {
  private final OSEnum myOperatingSystem;
  ...
  public TerminalKeyEncoder(OSEnum operatingSystem) {
  ...
  private void configureLeftRight() {
    if (myOperatingSystem == OSEnum.Mac) {
