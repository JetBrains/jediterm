package com.jediterm.core.model;
...
import com.jediterm.core.emulator.mouse.*;
...
public class JediTerminal implements Terminal, TerminalMouseListener, TerminalCoordinates {
  ...
  public JediTerminal(final TerminalDisplay display, final TerminalTextBuffer buf, final StyleState initialStyleState, OSEnum operatingSystem) {
    myDisplay = display;
    ...
    myTerminalKeyEncoder = new TerminalKeyEncoder(operatingSystem);
  ...
  @Override
  public void mouseWheelMoved(int x, int y, MouseEvent event) {
