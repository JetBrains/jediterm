...
import com.jediterm.core.StyledTextConsumer;
...
public final class TerminalLine {
  ...
  private @Nullable TerminalLine myTypeAheadLine;
  ...
  public @Nullable TerminalLine getTypeAheadLine() {
    return myTypeAheadLine;
  }

  public void setTypeAheadLine(@Nullable TerminalLine typeAheadLine) {
