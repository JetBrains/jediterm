...
class ChangeWidthOperation {
  ...
  void run() {
    LinesStorage historyLinesStorage = myTextBuffer.getHistoryLinesStorageOrBackup();
    ...
    LinesStorage screenLinesStorage = myTextBuffer.getScreenLinesStorageOrBackup();
